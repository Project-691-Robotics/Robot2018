...
public class RobotMap {
    ...
    public static void init() {
        ...
        LiveWindow.addSensor("Intake", "Ultrasonic", intakeUltrasonic);
        ...
        LiveWindow.addActuator("Elevator", "Motor 1", (Spark) elevatorMotor1);
        elevatorMotor1.setInverted(false);
        elevatorMotor2 = new Spark(5);
        LiveWindow.addActuator("Elevator", "Motor 2", (Spark) elevatorMotor2);
        elevatorMotor2.setInverted(false);
        elevatorMotorGroup = new SpeedControllerGroup(elevatorMotor1, elevatorMotor2  );
        LiveWindow.addActuator("Elevator", "Motor Group", elevatorMotorGroup);
