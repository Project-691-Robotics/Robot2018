...
public class Robot extends TimedRobot {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=AUTONOMOUS
        ...
        SmartDashboard.putNumber("AUTO Inches", 18);
        SmartDashboard.putNumber("MMT Inches", 18);
        SmartDashboard.putNumber("AUTO Encoder", 1000);
    }
    ...
    public void autonomousPeriodic() {
        Scheduler.getInstance().run();
        if (drivetrain.getEncoders() < SmartDashboard.getNumber("AUTO Encoder", 1000)) {
        	drivetrain.driveAuto(1);
        } else {
