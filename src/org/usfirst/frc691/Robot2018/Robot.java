...
public class Robot extends TimedRobot {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        chooser.addObject("AutoGroupTest (TEST!!)", agt);
        chooser.addObject("MotionMagicTest", mmt);
    ...
    public void autonomousInit() {
    	...
    	System.out.println("My color on scale is on the " + (gameData.charAt(0) == 'L' ? "LEFT" : "RIGHT"));
