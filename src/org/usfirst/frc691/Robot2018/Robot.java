...
public class Robot extends TimedRobot {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        elevator.setInverted(SmartDashboard.getBoolean("Elevator Inverted", false));
        ...
        spotChooser.addDefault("Left", 1);
        spotChooser.addObject("Middle", 0);
        spotChooser.addObject("Right", -1);
        ...
        autoChooser.addObject("AutoGroupTest (TEST!!)", agt);
        autoChooser.addObject("MotionMagicTest", mmt);
        autoChooser.addObject("AutoMidGroup", amg);
    ...
    public void disabledPeriodic() {
        ...
        oi.tt.setAngle((int) SmartDashboard.getNumber("TT Angle", 90));
    }
    ...
    public void teleopPeriodic() {
        Scheduler.getInstance().run();
        if (oi.astick.getTrigger()) {
        	RobotMap.intakeServo.set(0.43);
        } else {
        	RobotMap.intakeServo.set(1);
        }
    }
}
