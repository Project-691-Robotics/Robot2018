...
public class Robot extends TimedRobot {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=AUTONOMOUS
        ...
        SmartDashboard.putNumber("AUTO Inches", 1000);
        SmartDashboard.putNumber("MMT Inches", 1000);
    }
    ...
    public void disabledPeriodic() {
        ...
        oi.mmt.setDistInches(SmartDashboard.getNumber("MMT Inches", 1000));
        auto.setDistInches(SmartDashboard.getNumber("AUTO Inches", 1000));
    }
